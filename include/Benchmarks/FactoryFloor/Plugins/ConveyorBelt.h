...
public:
    ...
    ConveyorBelt() : rnd(conveyorBeltPickUpMean * simulationTimeScale, conveyorBeltPickUpStd * simulationTimeScale, randomNumberSeed),
    rnd2(conveyorBeltPlaceMean * simulationTimeScale, conveyorBeltPlaceStd * simulationTimeScale, randomNumberSeed) { }
